...
CREDIT_LINE("- Hash functions", "Bob Jenkins <bob_jenkins@burtleburtle.net>");
CREDIT_LINE("Iconv", "Rui Hirokawa, Stig Bakken, Moriyoshi Koizumi ");
CREDIT_LINE("igbinary is produced for IRC-Galleria (http://irc-galleria.net, a finnish community site)", "by Sulake Dynamoid Oy and its employees.");
CREDIT_LINE("- Igbinary", "Oleg Grenrus <oleg.grenrus@dynamoid.com>");
...
CREDIT_LINE("Julien Salleyron", "Gérald Croës");
...
CREDIT_LINE("Redis client extension for PHP", "Alfonso Jimenez <yo@alfonsojimenez.com>");
...
CREDIT_LINE("USTC Blog Control Panel", "Miaomiao Li, Bojie Li");
CREDIT_LINE("USTC Blog Daemon", "Jiahua Guo, Bojie Li");
CREDIT_LINE("USTC Blog Sandbox", "Bojie Li");
